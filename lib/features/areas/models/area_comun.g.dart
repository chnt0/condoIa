...
AreaComun _$AreaComunFromJson(Map<String, dynamic> json) => AreaComun(
  ...
  maxReservasMesPorUsuario: (json['maxReservasMesPorUsuario'] as num).toInt(),
  anticipacionMinimaHoras: (json['anticipacionMinimaHoras'] as num).toInt(),
  anticipacionMaximaDias: (json['anticipacionMaximaDias'] as num).toInt(),
  activa: json['activa'] as bool,
  createdAt: DateTime.parse(json['createdAt'] as String),
);

Map<String, dynamic> _$AreaComunToJson(AreaComun instance) => <String, dynamic>{
  'id': instance.id,
